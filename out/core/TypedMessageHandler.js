...
exports.disposeGlobalTypedMessageHandler = exports.getGlobalTypedMessageHandler = exports.TypedMessageHandler = void 0;
/**
...
class TypedMessageHandler {
    ...
    setupGlobalErrorHandlers() {
        ...
        process.on("unhandledRejection", (reason) => {
            console.error("❌ TypedMessageHandler 처리되지 않은 Promise 거부:", reason);
            this.messageStats.failed++;
        });
    }
    /**
